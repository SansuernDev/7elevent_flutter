...
class AppColorsExtension extends ThemeExtension<AppColorsExtension> {
  AppColorsExtension({
    ...
    required this.red2,
    required this.redPinLight,
    required this.buttonStatePress,
    required this.buttonStateDisable,
  });
  ...
  final Color grey800;
  final Color grey900;
  final Color redPinLight;
  final Color buttonStatePress;
  final Color buttonStateDisable;
  ...
  ThemeExtension<AppColorsExtension> copyWith({
    ...
    Color? grey900,
    Color? redPinLight,
    Color? buttonStatePress,
    Color? buttonStateDisable,
  }) {
    return AppColorsExtension(
      ...
      redPinLight: redPinLight ?? this.redPinLight,
      buttonStatePress: buttonStatePress ?? this.buttonStatePress,
      buttonStateDisable: buttonStateDisable ?? this.buttonStateDisable,
    );
  }
  ...
  AppColorsExtension lerp(ThemeExtension<AppColorsExtension>? other, double t) {
    ...
    return AppColorsExtension(
      ...
      red2: Color.lerp(red2, other.red2, t) ?? red2,
      ...
      greyBlue: Color.lerp(greyBlue, other.greyBlue, t) ?? greyBlue,
      ...
      redPinLight: Color.lerp(redPinLight, other.redPinLight, t) ?? redPinLight,
      buttonStatePress: Color.lerp(buttonStatePress, other.buttonStatePress, t) ?? buttonStatePress,
      buttonStateDisable: Color.lerp(buttonStateDisable, other.buttonStateDisable, t) ?? buttonStateDisable,
    );
  }
}
